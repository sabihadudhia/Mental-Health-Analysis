...
class DataProcessor:
    def __init__(self, input_path: str, output_dir: str = 'Data Processing'):
        ...
        # Create directories
        for directory in [self.plots_dir, self.visualizations_dir, self.results_dir]:
            os.makedirs(directory, exist_ok=True)
            
        logging.info(f"DataProcessor initialized with output directories in {self.output_dir}")
    ...
    def save_processed_data(self) -> None:
        ...
        try:
            ...
            # Save scores to data/processed directory
            scores_df = self.df[score_columns].copy()
            scores_file = os.path.join(processed_dir, 'mental_health_scores.csv')
            ...
            stats_file = os.path.join(self.results_dir, 'score_statistics.csv')
    ...
    def create_summary_visualizations(self, output_dir: str = 'plots') -> None:
        ...
        try:
            ...
            plots_dir = self.visualizations_dir
            os.makedirs(plots_dir, exist_ok=True)
            pdf_path = os.path.join(plots_dir, 'data_summary.pdf')
    ...
    def plot_correlation_matrix(self) -> None:
        ...
        try:
            ...
            output_file = os.path.join(plots_dir, 'correlation_matrix.png')
        ...
        try:
            ...
            for col in score_columns:
                if col in self.df.columns:
                    ...
                    output_file = os.path.join(plots_dir, f'{col}_distribution.png')
                    plt.savefig(output_file)
                    plt.close()
